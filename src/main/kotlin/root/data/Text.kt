...
data class Text(
    ...
    @SerialName("err-clb-user") val errClbUser: String,
    ...
    @SerialName("clb-survey-save") val clbSurveySave: String,
    ...
    @SerialName("back-to-survey-question-menu") val backToSurveyQuestionMenu: String,
    @SerialName("err-survey-enter-number") val errSurveyEnterNumber: String,
    @SerialName("msg-survey-question-actions-text") val msgSurveyQuestionActionsText: String,
    @SerialName("msg-survey-option-actions-text") val msgSurveyOptionActionsText: String,
    @SerialName("msg-survey-question-actions-sort") val msgSurveyQuestionActionsSort: String,
    @SerialName("survey-question-create") val surveyQuestionCreate: String,
    @SerialName("back-to-survey-questions-list-menu") val backToSurveyQuestionsListMenu: String,
    @SerialName("back-to-survey-option-menu") val backToSurveyOptionMenu: String,
    @SerialName("msg-survey-option-actions-sort") val msgSurveyOptionActionsSort: String,
    @SerialName("msg-survey-option-actions-value") val msgSurveyOptionActionsValue: String,
    ...
    @SerialName("file-name-text-tmp") val fileNameTextTmp: String,
    @SerialName("msg-data-in-table-not-exist") val msgDataInTableNotExist: String,
    @SerialName("get-table-file") val getTableFile: String,
    @SerialName("send-campaigns-table") val sendCampaignsTable: String,
    @SerialName("send-users-in-campaign") val sendUsersInCampaign: String,
    @SerialName("send-super-admin-table") val sendSuperAdminTable: String,
    @SerialName("send-admins-table") val sendAdminsTable: String,
    @SerialName("send-surveys-table") val sendSurveysTable: String,
    @SerialName("msg-surveys-table") val msgSurveysTable: String,
    @SerialName("msg-admins-table") val msgAdminsTable: String,
    @SerialName("msg-users-in-campaign") val msgUsersInCampaign: String,
    @SerialName("msg-user-info") val msgUserInfo: String,
    @SerialName("send-user-info") val sendUserInfo: String,
    @SerialName("user-campaigns-task") val userCampaignsTask: String,
